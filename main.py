...
if __name__ == "__main__":
    ...
    os.system("""python generate.py --task t2v-1.3B --size 832*480 --ckpt_dir ./Wan2.1-T2V-1.3B --edit_mode "True" --input_paths "/storage/itaytuviah/SAMWISE/assets/example_video.mp4" --subject_prompts "the horse jumping" --edit_prompts "a blue zebra" --base_seed 1024 --experiment_name "samwise_mask" """)