...
if __name__ == "__main__":
    ...
    for timestep in [3,4,5,6,7,8,9]: # [0, 11, 2]: #range(0, 20, 2):
        for self_attn_option in [0,1,2,3,4,5,6,7,11,12]: #range(13):
            for cross_attn_option in [0,1,2]: #range(5):
